...
- **Original (SQL Server):** `/Users/pierre.ribeiro/workspace/projects/amyris/sqlserver-to-postgresql-migration/source/original/sqlserver/11. create-routine/0. perseus.dbo.AddArc.sql`
- **Converted (PostgreSQL):** `/Users/pierre.ribeiro/workspace/projects/amyris/sqlserver-to-postgresql-migration/source/original/pgsql-aws-sct-converted/19. create-function/0. perseus.addarc.sql`
