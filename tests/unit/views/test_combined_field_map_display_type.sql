-- ===================================================================
-- UNIT TEST: test_combined_field_map_display_type
-- ===================================================================
-- Purpose: Comprehensive test suite for perseus.combined_field_map_display_type
-- Priority: P2
-- Task: T050 (US1 Phase 3 — Validation)
-- Object: perseus.combined_field_map_display_type
-- Type: VIEW (standard)
-- Created: 2026-03-08
-- ===================================================================
...
BEGIN
    ...
    WHERE table_schema = 'perseus'
      AND table_name   = 'combined_field_map_display_type';
    ...
    ELSE
        INSERT INTO test_results VALUES (1, 'View Existence', 'FAILED',
            'View perseus.combined_field_map_display_type not found in information_schema.views', v_elapsed);
    END IF;
...
BEGIN
    ...
    ELSE
        INSERT INTO test_results VALUES (2, 'Column Structure', 'FAILED',
            'No columns found for perseus.combined_field_map_display_type', v_elapsed);
    END IF;
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM perseus.combined_field_map_display_type;
...
BEGIN
    ...
    PERFORM * FROM perseus.combined_field_map_display_type LIMIT 1000;
...
BEGIN
    ...
    SELECT COUNT(*)
    INTO v_count
    FROM (SELECT * FROM perseus.combined_field_map_display_type LIMIT 100) sub;
...
SELECT '=====================================================================' AS separator
UNION ALL SELECT 'UNIT TEST RESULTS: combined_field_map_display_type'
UNION ALL SELECT '====================================================================='
UNION ALL SELECT '';
