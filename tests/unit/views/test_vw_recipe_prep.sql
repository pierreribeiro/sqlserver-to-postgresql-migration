-- ===================================================================
-- UNIT TEST: test_vw_recipe_prep
-- ===================================================================
-- Purpose: Comprehensive test suite for perseus.vw_recipe_prep
-- Priority: P2
-- Task: T050 (US1 Phase 3 — Validation)
-- Object: perseus.vw_recipe_prep
-- Type: VIEW (standard)
-- Created: 2026-03-08
-- ===================================================================
...
BEGIN
    ...
    ELSE
        INSERT INTO test_results VALUES (1, 'View Existence', 'FAILED',
            'View perseus.vw_recipe_prep not found in information_schema.views', v_elapsed);
    END IF;
...
BEGIN
    ...
    ELSE
        INSERT INTO test_results VALUES (2, 'Column Structure', 'FAILED',
            'No columns found for perseus.vw_recipe_prep', v_elapsed);
    END IF;
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM perseus.vw_recipe_prep;
...
BEGIN
    ...
    PERFORM * FROM perseus.vw_recipe_prep LIMIT 1000;
...
BEGIN
    ...
    SELECT COUNT(*)
    INTO v_count
    FROM (SELECT * FROM perseus.vw_recipe_prep LIMIT 100) sub;
...
SELECT '=====================================================================' AS separator
UNION ALL SELECT 'UNIT TEST RESULTS: vw_recipe_prep'
UNION ALL SELECT '====================================================================='
UNION ALL SELECT '';
