-- ===================================================================
-- UNIT TEST: test_vw_recipe_prep_part
-- ===================================================================
-- Purpose: Comprehensive test suite for perseus.vw_recipe_prep_part
-- Priority: P2
-- Task: T050 (US1 Phase 3 — Validation)
-- Object: perseus.vw_recipe_prep_part
-- Type: VIEW (standard)
-- Created: 2026-03-08
-- ===================================================================
...
BEGIN
    ...
    WHERE table_schema = 'perseus'
      AND table_name   = 'vw_recipe_prep_part';
    ...
    ELSE
        INSERT INTO test_results VALUES (1, 'View Existence', 'FAILED',
            'View perseus.vw_recipe_prep_part not found in information_schema.views', v_elapsed);
    END IF;
...
BEGIN
    ...
    ELSE
        INSERT INTO test_results VALUES (2, 'Column Structure', 'FAILED',
            'No columns found for perseus.vw_recipe_prep_part', v_elapsed);
    END IF;
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM perseus.vw_recipe_prep_part;
...
BEGIN
    ...
    PERFORM * FROM perseus.vw_recipe_prep_part LIMIT 1000;
...
BEGIN
    ...
    SELECT COUNT(*)
    INTO v_count
    FROM (SELECT * FROM perseus.vw_recipe_prep_part LIMIT 100) sub;
...
SELECT '=====================================================================' AS separator
UNION ALL SELECT 'UNIT TEST RESULTS: vw_recipe_prep_part'
UNION ALL SELECT '====================================================================='
UNION ALL SELECT '';
