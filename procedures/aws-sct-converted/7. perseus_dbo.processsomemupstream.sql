CREATE OR REPLACE PROCEDURE perseus_dbo.processsomemupstream(IN par_dirty_in perseus_dbo.goolist, IN par_clean_in perseus_dbo.goolist, INOUT p_refcur refcursor)
AS 
$BODY$
