CREATE OR REPLACE FUNCTION perseus_dbo.getmaterialbyrunproperties()
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF var_OriginalGoo IS NOT NULL THEN
        ...
        IF var_TimePointGoo IS NULL THEN
            ...
            PERFORM perseus_dbo.materialtotransition(var_OriginalGoo, var_Split);
            PERFORM perseus_dbo.transitiontomaterial(var_Split, var_TimePointGoo);
        END IF;
    END IF;
